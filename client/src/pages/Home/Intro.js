...
const Intro = () => {
  return (
    <div className='h-[80vh] bg-primary flex flex-col items-start justify-center gap-8 py-10'>
        ...
        <h1 className='text-6xl sm:text-3xl text-secondary font-semibold'>Rahul Kumar Singh </h1>
        <h1 className='text-4xl sm:text-2xl text-white font-semibold'>I build things for the web </h1>
